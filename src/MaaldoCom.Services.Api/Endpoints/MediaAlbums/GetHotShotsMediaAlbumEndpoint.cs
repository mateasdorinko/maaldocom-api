...
public class GetHotShotsMediaAlbumEndpoint(IQueryHandler<GetHotshotsMediaAlbumDetailQuery, MediaAlbumDto> handler) : EndpointWithoutRequest<GetMediaAlbumDetailResponse>
{
