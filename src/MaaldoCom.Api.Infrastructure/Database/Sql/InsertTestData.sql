...
insert into MediaAlbums (CreatedBy, Created, Active, Name, Slug,Description)
values ('test-runner','2025-12-30T16:25:00',1,'Test Media Album 1','test-media-album-1','test description 1');
SET @testAlbum1 = (select Id from MediaAlbums where Slug = 'test-media-album-1')
...
SET @testAlbum2 = (select Id from MediaAlbums where Slug = 'test-media-album-2')
...
SET @testAlbum3 = (select Id from MediaAlbums where Slug = 'test-media-album-3')
...
SET @testAlbum4 = (select Id from MediaAlbums where Slug = 'test-media-album-4')
...
SET @testAlbum5 = (select Id from MediaAlbums where Slug = 'test-media-album-5')
